import { clsPopWrapper , log , colorReg , clsBold , clsColor , clsToolCommand , clsActive } from './variables'
...
export default {
    ...
    getToolBar(){
        return `
            ...
            <span class="${clsToolCommand} ${clsColor} tool-color-333333">
                <i></i>
            </span>
            <span class="${clsToolCommand} ${clsColor} tool-color-EF8D2A">
                <i></i>
            </span>
            <span class="${clsToolCommand} ${clsColor} tool-color-666666">
                <i></i>
            </span>
        `
    } ,
